...
//		Collections.sort(listProductSortByPrice,Comparator.comparing(Product::getPrice));
	...
	public String sortByName(Model model) {
		...
		//sắp xếp theo chữ z đến a
//		Collections.sort(listProductSortByName,Comparator.comparing(Product::getName).reversed());
...
//	@RequestMapping("/home/shop/findByPrice")
//	public String productFindByPrice(Model model,@RequestParam("keyword") String kw) {
//		List<Product> list = productService.findByPrice("%" + kw + "%");
//		model.addAttribute("items", list);
//		return "/product/shop";
//	}
}
